...
\addcontentsline{toc}{section}{4.1 \hspace{0.25cm} Discussion on genomics data integration}
...
\addcontentsline{toc}{section}{4.2 \hspace{0.25cm} Discussion on high dimensionality of genomics data}
...
\addcontentsline{toc}{section}{4.3 \hspace{0.25cm} Discussion on feature selection}
...
\addcontentsline{toc}{section}{4.4 \hspace{0.25cm} Discussion on statistical inference}
...
One way of inference is utilizing the Bayesian interpretation of regularized regression. For example, the linear regression lasso
\begin{displaymath}
